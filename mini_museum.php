...
<body>
    ...
    <h1>Museum Reservations</h1>
    <div class='table-container'>
        <?php
        for ($i = 1; $i <= $numTables; $i++) {
            echo "<h2 class='tnum'>Table $i</h2>";
            echo "<table border='1'>";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='edit_museum_reservation.php?reservation_id=" . $row['reservation_id'] . "'><button class='edit-link'>Edit</button></a>
                    <a href='delete_museum_reservation.php?reservation_id=" . $row['reservation_id'] . "'><button class='delete-link'>Delete</button></a></td>";
        ...
        ?>
        <div class="add">
            <button onclick="window.location.href = 'add_museum_reservation.php'">Add New Reservation</button>
        </div>
